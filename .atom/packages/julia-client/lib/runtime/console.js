...
export function activate (_ink) {
  ...
  subs.add(
    ...
    atom.commands.add('.julia-terminal', {
      ...
      'custom:insert-subscript-1': () => {
        terminal.ty.write('₁')
      },
      'custom:insert-subscript-2': () => {
        terminal.ty.write('₂')
      },
      'custom:insert-subscript-3': () => {
        terminal.ty.write('₃')
      },
      'custom:insert-subscript-4': () => {
        terminal.ty.write('₄')
      },
      'custom:insert-subscript-5': () => {
        terminal.ty.write('₅')
      },
      'custom:insert-subscript-6': () => {
        terminal.ty.write('₆')
      },
      'custom:insert-subscript-7': () => {
        terminal.ty.write('₇')
      },
      'custom:insert-subscript-8': () => {
        terminal.ty.write('₈')
      },
      'custom:insert-subscript-9': () => {
        terminal.ty.write('₉')
      },
      'custom:insert-subscript-0': () => {
        terminal.ty.write('₀')
      },
      'custom:insert-superscript-1': () => {
        terminal.ty.write('¹')
      },
      'custom:insert-superscript-2': () => {
        terminal.ty.write('²')
      },
      'custom:insert-superscript-3': () => {
        terminal.ty.write('³')
      },
      'custom:insert-superscript-4': () => {
        terminal.ty.write('⁴')
      },
      'custom:insert-superscript-5': () => {
        terminal.ty.write('⁵')
      },
      'custom:insert-superscript-6': () => {
        terminal.ty.write('⁶')
      },
      'custom:insert-superscript-7': () => {
        terminal.ty.write('⁷')
      },
      'custom:insert-superscript-8': () => {
        terminal.ty.write('⁸')
      },
      'custom:insert-superscript-9': () => {
        terminal.ty.write('⁹')
      },
      'custom:insert-superscript-0': () => {
        terminal.ty.write('⁰')
      },
      'custom:insert-superscript-open-parenthesis': () => {
        terminal.ty.write('⁽')
      },
      'custom:insert-superscript-close-parenthesis': () => {
        terminal.ty.write('⁾')
      },
      'custom:insert-subscript-a': () => {
        terminal.ty.write('ₐ')
      },
      'custom:insert-subscript-e': () => {
        terminal.ty.write('ₑ')
      },
      'custom:insert-subscript-l': () => {
        terminal.ty.write('ₗ')
      },
      'custom:insert-subscript-m': () => {
        terminal.ty.write('ₘ')
      },
      'custom:insert-subscript-n': () => {
        terminal.ty.write('ₙ')
      },
      'custom:insert-subscript-p': () => {
        terminal.ty.write('ₚ')
      },
      'custom:insert-subscript-s': () => {
        terminal.ty.write('ₛ')
      },
      'custom:insert-subscript-u': () => {
        terminal.ty.write('ᵤ')
      },
      'custom:insert-subscript-v': () => {
        terminal.ty.write('ᵥ')
      },
      'custom:insert-perp': () => {
        terminal.ty.write('˔')
      ...
      'custom:insert-approximate-equal': () => {
        terminal.ty.write('≈')
      },
    }),
    // terminal commands
